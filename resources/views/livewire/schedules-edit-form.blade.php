...
<form wire:submit="update" class="p-5">
       ...
       <x-input-label for="from" :value="__('From')" />
        <input type="time" wire:model= "from"  class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" >
        <x-input-error :messages="$errors->get('from')" class="mt-2" />   
    </div>

       <div class="py-3">
       <x-input-label for="to" :value="__('To')" />
        <input type="time" wire:model= "to"class="py-3 px-4 pe-9 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" >
