...
@if(count($schedules) > 0)
    @foreach($schedules as $item)
                    ...
                    <span class="font-semibold text-sm text-gray-800 dark:text-neutral-200">{{$loop->iteration}}</span>
                              ...
                              <td class="h-px w-auto whitespace-nowrap">
                    <div class="px-6 py-2">
                    <span class="font-semibold text-sm text-gray-800 dark:text-neutral-200">{{$daysOfweek[$item->available_day] }}</span>   
                                </div>
                              </td>

                              <td class="h-px w-auto whitespace-nowrap">
                    <div class="px-6 py-2">
                    <span class="font-semibold text-sm text-gray-800 dark:text-neutral-200">{{$item->from }}</span>   
                                </div>
                              </td>

                              <td class="h-px w-auto whitespace-nowrap">
                    <div class="px-6 py-2">
                    <span class="font-semibold text-sm text-gray-800 dark:text-neutral-200">{{$item->to }}</span>   
                                </div>
                              </td>
